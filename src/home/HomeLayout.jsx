import SignupCTA from "/src/home/_component/SignupCTA";
import Layout from "/src/Layout";

export default function HomeLayout({ children }) {
  return <Layout heroHeader={<HeroHeader />}>{children}</Layout>;
}

function HeroHeader() {
  return (
    <div className="mt-[6.3rem] flex flex-col items-center gap-[2.4rem] pt-[2.8rem] tablet:mt-[9.4rem] tablet:gap-[4rem] tablet:pt-[7rem]">
      <h1 className="text-center text-[3.2rem] font-bold leading-[1.4] tablet:text-[6.4rem] tablet:leading-[8rem]">
