import { isEmptyString, navigateWithTokenCheck } from '/src/scripts/utils.js';
...
const passwordEyeIcon = document.querySelector('.form__password .form__input--eye-off');
...
passwordEyeIcon.addEventListener('click', changePasswordVisibility(passwordInput));
...
passwordChkEyeIcon.addEventListener('click', changePasswordVisibility(passwordInputChk));
